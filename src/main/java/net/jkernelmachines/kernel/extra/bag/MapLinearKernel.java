...
/**
 * Kernel that takes sparse histograms as input and computes the dot product.
 * The histograms are represented by a map with the bins as keys (generic type)
 * and a double as value for the corresponding number of elements in that bin.
 * 
 * @author picard
 * @param <T>
 ...
 *
 */
public class MapLinearKernel<T> extends Kernel<Map<T, Double>> {
