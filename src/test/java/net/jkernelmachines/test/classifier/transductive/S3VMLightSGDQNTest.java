...
import net.jkernelmachines.classifier.transductive.S3VMLightSGDQN;
...
public class S3VMLightSGDQNTest {
	...
	/**
	 * Test method for {@link net.jkernelmachines.classifier.transductive.S3VMLightSGDQN#train(java.util.List, java.util.List)}.
	 */
	@Test
